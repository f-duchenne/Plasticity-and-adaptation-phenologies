...
setwd(dir="C:/Users/Duchenne/Documents/plast_adaptation/data/variations")
resf=NULL
lili=list.files()
for(i in lili){
bidon=fread(i,sep="\t")
...
facet_zoom2 <- function(x, y, xy, zoom.data, xlim = NULL, ylim = NULL,split = FALSE, horizontal = TRUE, zoom.size = 2,show.area = TRUE, shrink = TRUE){
...
# package version.
FacetZoom2 <- ggproto("FacetZoom2",ggforce::FacetZoom,compute_layout = function(data, params){
